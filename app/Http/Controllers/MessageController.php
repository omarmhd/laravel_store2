...
class MessageController extends Controller
{
    ...
    public function destroy($id){
     ...
     public function laravelMessenger($withId)
     {
        ...
        //  dd($withId);
        //  if(!(($withUser->hasRole('seller') && auth()->user()->hasRole('client'))||($withUser->hasRole('client') && auth()->user()->hasRole('seller'))) && $withId != 1){
        //     return redirect('/');
        //  }
     ...
     public function store(Request $request)
     {
        ...
        //  if(!(($user->hasRole('seller') && auth()->user()->hasRole('client'))||($user->hasRole('client') && auth()->user()->hasRole('seller')))  && $withId != 1){
